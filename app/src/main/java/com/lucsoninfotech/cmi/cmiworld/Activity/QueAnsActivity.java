            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (error == 0) {
                        ...
                        Intent i = new Intent(QueAnsActivity.this, LoginActivity.class);
                        startActivity(i);
                        finish();
                    } else {
...
import com.lucsoninfotech.cmi.cmiworld.other.AppController;
import com.lucsoninfotech.cmi.cmiworld.other.Constant;
import com.lucsoninfotech.cmi.cmiworld.other.CustomViewPager;
...
public class QueAnsActivity extends AppCompatActivity implements QueAnsFragment.OnGetFromUserClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 5; i++) {
            Bundle bundle = new Bundle();
            bundle.putInt("id", i);
            QueAnsFragment frag1 = new QueAnsFragment();
            frag1.setArguments(bundle);
            fragment.add(frag1);
            answer.add("");
        }
        QueAnsAdapter queAnsAdapter = new QueAnsAdapter(getSupportFragmentManager(), fragment);
    ...
    private void setQueAns() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Constant.Question_Url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.d("Resp", response);
                Log.d("Resp", Constant.Question_Url);

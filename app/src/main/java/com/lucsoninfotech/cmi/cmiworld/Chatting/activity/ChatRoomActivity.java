...
import com.lucsoninfotech.cmi.cmiworld.Chatting.adapter.ChatRoomThreadAdapter;
import com.lucsoninfotech.cmi.cmiworld.Chatting.gcm.NotificationUtils;
...
public class ChatRoomActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        ...
        String endPoint = Constant.CHAT_ROOM_MESSAGE.replace("_ID_", chatRoomId);
    ...
    private void fetchChatThread() {
        ...
        String endPoint = Constant.CHAT_THREAD.replace("_ID_", chatRoomId);
        Log.e(TAG, "endPoint: " + endPoint);

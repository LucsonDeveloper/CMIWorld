...
package com.lucsoninfotech.cmi.cmiworld.Chatting.gcm;
...
import com.lucsoninfotech.cmi.cmiworld.Chatting.activity.ChatRoomActivity;
import com.lucsoninfotech.cmi.cmiworld.Chatting.activity.Chat_Main_Activity;
import com.lucsoninfotech.cmi.cmiworld.Chatting.model.Message;
...
public class MyGcmPushReceiver extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle bundle) {
        ...
        switch (Integer.parseInt(flag)) {
            case Constant.PUSH_TYPE_CHATROOM:
                // push notification belongs to a chat room
                processChatRoomPush(title, isBackground, data);
                break;
            case Constant.PUSH_TYPE_USER:
    ...
    private void processChatRoomPush(String title, boolean isBackground, String data) {
        if (!isBackground) {
            ...
            try {
                ...
                if (uObj.getString("user_id").equals(Constant.USER_ID)) {
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    pushNotification.putExtra("type", Constant.PUSH_TYPE_CHATROOM);
        ...
        if (!isBackground) {
            ...
            try {
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    // app is in foreground, broadcast the push message
                    Intent pushNotification = new Intent(Constant.PUSH_NOTIFICATION);
                    pushNotification.putExtra("type", Constant.PUSH_TYPE_USER);
                    pushNotification.putExtra("message", message);
                    LocalBroadcastManager.getInstance(this).sendBroadcast(pushNotification);
                    ...
                    // app is in background. show the message in notification try
                    Intent resultIntent = new Intent(getApplicationContext(), Chat_Main_Activity.class);
